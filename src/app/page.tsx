...
<div className="flex flex-wrap  w-[100%]  justify-center  gap-4 ">
      ...
      <div className="rotate-center border-2 mt- w-96 h-96 bg-white rounded-xl shadow-lg p-3 hover:bg-blue-400 duration-100text-white mt-8 sm:w-72 md:w-80">
      ...
      <div className="rotate-center border-2 mt- w-96 h-96 bg-white rounded-xl shadow-lg p-3 hover:bg-blue-400 duration-100text-white mt-8 sm:w-72 md:w-80">
        <div className="rotate-center ml-4 border-2 w-80 h-40 bg-black rounded-xl shadow-lg relative sm:w-64 sm:ml-0 md:w-72 ">
          <Image 
            src={img} 
            alt="Blog Image" 
            objectFit="cover" 
      ...
      <div className="rotate-center ml-4 border-2 mt- w-96 h-96 bg-white rounded-xl shadow-lg p-3 hover:bg-blue-400 duration-100text-white mt-8 sm:w-72 md:w-80">
        <div className="rotate-scale-up ml-4 border-2 w-80 h-40 bg-black rounded-xl shadow-lg relative sm:w-64 sm:ml-0 md:w-72 ">
          <Image 
            src={img} 
            alt="Blog Image" 
